...
from service.forms import MailingForm, MessageForm, ClientForm, MailingModeratorForm
from service.models import Message, Mailing, Client, Logs
from service.services import get_cache_for_mailings, get_cache_for_active_mailings
...
class MessageUpdateView(LoginRequiredMixin, UpdateView):
    ...
    def get_success_url(self):
        return reverse('service:message_view', args=[self.kwargs.get('pk')])
